<template>
    <div style="background-color: #fff; padding: 30px;border-radius: 15px;">
        <div class="custom-row">
            <div class="col-xs-12 mb-5" style="display: flex;">
                <v-btn color="primary" dark @click="print">Print</v-btn>
            </div>
        </div>
        ...
        <div id="invoiceContent">
                    ...
                    <table class="invoice-details" border="1px solid #ccc;">
                        <thead>
                            <tr>
                                ...
                                <td class="text-center font-bold">Sale Price</td>
            ...
            <div class="custom-row">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12">
                        <div class="paid-text">
                            <strong class="b-text" style="font-weight:bold;"> In Words: </strong> <span class="normal-text">{{ convertNumberToWords(sale.total) }}</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="container">
                            ...
                            <div style="position:absolute;bottom:0px;left:50%;transform: translateX(-50%);">
                                <div class="custom-row" style="font-size:12px;">
                                    <div class="col-xs-12">
                                        <p class="normal-text"> Print Date: ${moment().format('DD-MM-YYYY h:mm a')}, Cashier: ${this.sale.added_by.name}  </p>
                                    </div>
                                </div>
                            </div>
